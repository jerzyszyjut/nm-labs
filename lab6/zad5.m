...
if isfield(energy, country) && isfield(energy.(country), source)
  ...
  for i = 1:N
    ...
    y_coarse_approximation = idct2_custom(X, i, N, N);
    
    mse(i) = mean((y_yearly - y_coarse_approximation).^2);
